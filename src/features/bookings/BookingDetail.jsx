  ...
  return (
    <>
      ...
      <ButtonGroup>
        ...
        {status === 'checked-out' && (
          <Button icon={<HiTrash />} onClick={() => deleteBooking(bookingId)} disabled={isDeleting}>
              Delete
          </Button>
        )}

          {status === 'checked-in' && <Button icon={<HiArrowDownOnSquare />} onClick={() => checkout(bookingId)} disabled={isCheckingOut}>
                      Check out
          </Button>}
